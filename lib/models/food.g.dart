...
const FoodSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isHostelFriendly': PropertySchema(
      id: 3,
      name: r'isHostelFriendly',
      type: IsarType.bool,
    ),
...
void _foodSerialize(
  ...
  writer.writeBool(offsets[3], object.isHostelFriendly);
...
Food _foodDeserialize(
  ...
  object.id = id;
  object.isHostelFriendly = reader.readBool(offsets[3]);
...
extension FoodQueryFilter on QueryBuilder<Food, Food, QFilterCondition> {
  ...
  QueryBuilder<Food, Food, QAfterFilterCondition> isHostelFriendlyEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isHostelFriendly',
        value: value,
      ));
    });
  }
...
extension FoodQuerySortBy on QueryBuilder<Food, Food, QSortBy> {
  ...
  QueryBuilder<Food, Food, QAfterSortBy> sortByIsHostelFriendly() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHostelFriendly', Sort.asc);
    });
  }

  QueryBuilder<Food, Food, QAfterSortBy> sortByIsHostelFriendlyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHostelFriendly', Sort.desc);
    });
  }
...
extension FoodQuerySortThenBy on QueryBuilder<Food, Food, QSortThenBy> {
  ...
  QueryBuilder<Food, Food, QAfterSortBy> thenByIsHostelFriendly() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHostelFriendly', Sort.asc);
    });
  }

  QueryBuilder<Food, Food, QAfterSortBy> thenByIsHostelFriendlyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHostelFriendly', Sort.desc);
    });
  }
...
extension FoodQueryWhereDistinct on QueryBuilder<Food, Food, QDistinct> {
  ...
  QueryBuilder<Food, Food, QDistinct> distinctByIsHostelFriendly() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isHostelFriendly');
    });
  }
...
extension FoodQueryProperty on QueryBuilder<Food, Food, QQueryProperty> {
  ...
  QueryBuilder<Food, bool, QQueryOperations> isHostelFriendlyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isHostelFriendly');
    });
  }
